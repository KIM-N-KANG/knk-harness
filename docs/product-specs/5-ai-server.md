...
> 관측 그릇(트레이스 묶기·차원 부착)은 KNK-624(PR #56)로 **dev에 구현 완료**입니다(기준 코드 `1b33f64bc0d3`). 다만 프로덕션은 아직 미활성(키·배선 없음)이고, 정해진 장르만 태그(KNK-640 후속)·prod·JP 강제도 후속입니다. 턴·스토리 식별자 수신은 백엔드 협의 대상입니다.
