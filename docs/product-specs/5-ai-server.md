...
| 기준 코드 | `../manyak-ai` KNK-803 작업 브랜치 `151fe75`(2026-08-07, Python 3.11 · FastAPI)입니다. 기준 `dev`는 `9892b56`이며, KNK-803 AI 브랜치 병합과 운영 배포는 남아 있습니다. 운영 릴리스는 `v0.2.2`(main `4624fc2`)입니다. |
