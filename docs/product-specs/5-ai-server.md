...
| 기준 코드 | `../manyak-ai` `dev` 브랜치 `5da1dc0963a8` (2026-07-23, Python 3.11 · FastAPI). KNK-312 스토리라인 방어(재호출·stories 계약 검증·id 정규화, `13e30d1`)는 dev 머지 대기 상태로 선반영. 운영 릴리스는 `v0.2.1`(main `4bc9c1a`) |
