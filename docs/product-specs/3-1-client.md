...
- **리뷰·QA** — 각 화면·절의 검수 기준과 §3-1-9 간극 표(G2~G6), 플랫폼 문서의 테스트 절에서 시작해 본문을 역참조합니다.
...
- 채운 뒤 내용을 전부 지우고 새로 써도 `edited_choice`입니다. 추천을 본 뒤의 입력이라 순수 `typed`와 구분하는 편이 선호 분석에 유용하고, "고쳐 쓴 것"의 극단으로 두는 편이 규칙이 단순합니다.
