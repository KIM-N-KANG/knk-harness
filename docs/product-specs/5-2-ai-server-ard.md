...
- **선택(2026-09-07, KNK-1218):** 현행 계약과 평가 시스템은 짧은 `5-1-ai-server-spec.md`, 과거 문제·선택·근거는 `5-2-ai-server-ard.md`로 나눕니다. 주요 흐름은 Mermaid로 설명하고 구현·실행법은 해당 레포에 연결합니다.
