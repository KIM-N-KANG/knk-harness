...
3. 본문 완성 후 사건·엔딩 판정과 이미지 처리를 동시에 시작합니다. 앞 지문을 보내고, 선택된
...
수집도 같은 마감 시각을 적용합니다. 이미지의 시간 초과는 전달 시각이 아닌 업로드까지 끝난 시각으로
...
이미지 결과를 기다린 뒤 첫 대사를 보내며 부모를 먼저 보여 줬다가 자식으로 교체하지 않습니다.
