...
| MY-INFO-03 | P1 | 페이지 표시됨 | 게스트 이용 안내 문구 확인 | "로그인 없이는 오리지널 스토리와 공개된 내용을 둘러볼 수 있어요. 스토리 만들기와 채팅은 로그인 후 필수 약관에 동의하면 이용할 수 있어요" + 예전 게스트 데이터의 브라우저 저장 한계 + 최초 로그인 1회 이관 안내 표시. 체험 한도 수치 없음(2026-09-19) | 수동 | FE-SCREEN-011, 웹 사용자 모델 |
