...
- 목표·적용 범위와 현재 구조를 먼저 확인합니다.
- 이번 이관 내역과 남은 분리 계획을 읽은 뒤 검증·복구 기준을 확인합니다.

## 목차

- [1. 목표와 적용 범위](#1-목표와-적용-범위)
- [2. 현재 구조와 본문 소유권](#2-현재-구조와-본문-소유권)
- [3. 이번 본문 이관](#3-이번-본문-이관)
- [4. 남은 본문 분리 계획](#4-남은-본문-분리-계획)
- [5. 진행 순서와 작성 규칙](#5-진행-순서와-작성-규칙)
- [6. 검증과 복구](#6-검증과-복구)

> 2026-09-12 후속: 백엔드·배포 문서를 재구성했습니다. 현재 계약은 백엔드 Spec, 현재 구조는 백엔드·배포 Design, 결정은 각 ADR이 소유합니다. 아래 내용은 당시 계획입니다.
